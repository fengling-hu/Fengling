...
#Merge Together
# temp <- left_join(B01001, B02001, by="GEOID")
# temp <- left_join(temp, B03001, by="GEOID")
# temp <- left_join(temp, B05002, by="GEOID")
# temp<-left_join(temp, B11001, by="GEOID")
# temp<-left_join(temp, B17001, by="GEOID")
# temp<-left_join(temp, B19013, by="GEOID")
# temp<-left_join(temp, B25002, by="GEOID")
# temp<-left_join(temp, B25003, by="GEOID")
# temp<-left_join(temp, B25077, by="GEOID")
# temp<-left_join(temp, B25106, by="GEOID")
# 
# 
# rm(B01001, B02001, B03001, B05002, B11001, B17001, B19013, B25002, B25003, B25077, B25106)
# 
# trt<-tracts(state=state, class = "sf")
# trt<-left_join(trt, temp, by="GEOID")
# dir.create("data")
# saveRDS(trt, "data/acs_tracts.rds")
